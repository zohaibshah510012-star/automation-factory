...
Baseline: `0001_content_factory.sql` through `0024_beta_operations.sql`.
...
- [ ] `supabase/migrations` is continuous from `0001` to `0024`
- [ ] Production Supabase shows all migrations applied through `0024_beta_operations.sql`
