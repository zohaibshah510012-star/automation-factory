...
- Latest expected migration: `0032_founder_revenue_validation.sql`
...
- Local migrations are continuous from `0001` to `0032`.
...
1. Apply Supabase migrations through `0032_founder_revenue_validation.sql`.
