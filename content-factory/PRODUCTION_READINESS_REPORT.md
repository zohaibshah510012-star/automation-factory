...
- Latest expected migration: `0024_beta_operations.sql`
...
- Local migrations are continuous from `0001` to `0024`.
...
1. Apply Supabase migrations through `0024_beta_operations.sql`.
