...
type Step = { id?: string; name: string; type: "prompt" | "ai_generate" | "image_generate" | "save_result"; agent_name?: string; config?: Record<string, unknown> };
